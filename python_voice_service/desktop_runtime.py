...
async def _build_asr_status_payload() -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "gemini_live_connected": bool(getattr(status, "gemini_live_connected", False)),
        "gemini_live_session_active": bool(getattr(status, "gemini_live_session_active", False)),
        "gemini_live_audio_queue_depth": int(getattr(status, "gemini_live_audio_queue_depth", 0) or 0),
